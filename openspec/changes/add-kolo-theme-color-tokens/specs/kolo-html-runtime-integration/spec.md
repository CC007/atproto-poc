...
#### Scenario: semantic Kolo theme colors call sites emit utility tokens
- **WHEN** browse/art render code replaces CSS-owned declarations with semantic Kolo theme colors DSL helpers
