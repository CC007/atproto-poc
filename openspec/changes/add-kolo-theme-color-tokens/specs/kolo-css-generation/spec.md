...
#### Scenario: semantic Kolo theme colors utility token is included in request
- **WHEN** a request includes a supported semantic Kolo theme colors token
