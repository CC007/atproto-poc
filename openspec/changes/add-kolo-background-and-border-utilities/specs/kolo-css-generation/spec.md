...
#### Scenario: background and border utility ownership utility token is included in request
- **WHEN** a request includes a supported background and border utility ownership token
