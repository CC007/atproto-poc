...
#### Scenario: background and border utility ownership call sites emit utility tokens
- **WHEN** browse/art render code replaces CSS-owned declarations with background and border utility ownership DSL helpers
