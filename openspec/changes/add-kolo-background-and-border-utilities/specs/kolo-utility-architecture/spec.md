...
#### Scenario: background and border utility ownership token is parsed for generation
- **WHEN** a supported background and border utility ownership token is parsed
