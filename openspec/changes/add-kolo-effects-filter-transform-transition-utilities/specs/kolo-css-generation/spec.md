...
#### Scenario: effects utility ownership utility token is included in request
- **WHEN** a request includes a supported effects utility ownership token
