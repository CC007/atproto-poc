...
#### Scenario: flexbox and grid utility ownership token is parsed for generation
- **WHEN** a supported flexbox and grid utility ownership token is parsed
