...
#### Scenario: interactivity and SVG utility ownership token is parsed for generation
- **WHEN** a supported interactivity and SVG utility ownership token is parsed
