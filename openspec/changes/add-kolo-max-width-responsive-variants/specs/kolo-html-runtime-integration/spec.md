...
#### Scenario: max-width responsive variants call sites emit utility tokens
- **WHEN** browse/art render code replaces CSS-owned declarations with max-width responsive variants DSL helpers
