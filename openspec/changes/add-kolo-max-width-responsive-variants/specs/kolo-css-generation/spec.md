...
#### Scenario: max-width responsive variants utility token is included in request
- **WHEN** a request includes a supported max-width responsive variants token
