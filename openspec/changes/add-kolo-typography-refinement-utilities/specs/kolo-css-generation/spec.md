...
#### Scenario: typography refinement utility ownership utility token is included in request
- **WHEN** a request includes a supported typography refinement utility ownership token
