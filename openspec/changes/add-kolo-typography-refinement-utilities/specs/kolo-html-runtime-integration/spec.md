...
#### Scenario: typography refinement utility ownership call sites emit utility tokens
- **WHEN** browse/art render code replaces CSS-owned declarations with typography refinement utility ownership DSL helpers
