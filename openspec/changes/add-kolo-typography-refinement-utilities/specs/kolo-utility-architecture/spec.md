...
#### Scenario: typography refinement utility ownership token is parsed for generation
- **WHEN** a supported typography refinement utility ownership token is parsed
