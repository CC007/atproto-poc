...
Only the gif is working. The other images don't load. Also, follow posts aren't supported yet.

## What Changes

Make sure that all images load and all dummy types are supported in the timeline
