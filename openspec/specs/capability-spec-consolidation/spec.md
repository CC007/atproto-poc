...
## Purpose
Define migration requirements for consolidating requirement-level behavior into OpenSpec capability specs and making specs/archive the authoritative requirement-discovery source.
