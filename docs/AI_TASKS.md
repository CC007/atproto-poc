...
| --- | --- | --- | --- | --- |
| `BA-003` | Explore CSS-in-Kotlin approach (ktor CSS DSL / Kotlinwind) | `partial` | `ai` | `docs/ai-tasks/2026-05-04-BA-003-explore-css-in-kotlin.md` |
...
| `BA-019` | Add first margin/padding utilities and preserve visual parity | `todo` | `ai` | `docs/ai-tasks/2026-05-06-BA-019-margin-padding-elements-csscontroller-cleanup-visual-parity.md` |
