...
| `BA‑021` | CSS endpoint to generate `kolo.css` from request parameters | `in_progress` | `ai` | [📋](ai-tasks/2026-05-09-BA-021-kolo-css-endpoint-generation-from-parameters.md) |
